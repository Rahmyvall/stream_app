...
class MovieController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $originalLargehumbnailName = Str::random(10) . $largeThumbnail->getClientOriginalName();

        $smallThumbnail->storeAs('public/thumbnail', $originalSmallThumbnailName);
        $largeThumbnail->storeAs('public/thumbnail', $originalLargehumbnailName);

        $data['smallThumbnail'] = $originalSmallThumbnailName;
        $data['largeThumbnail'] = $originalLargehumbnailName;
